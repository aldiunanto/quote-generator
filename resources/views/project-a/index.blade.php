			...
			<table class="bordered-bottom">
				...
				<tbody>
					<tr>
						...
						<td class="text-center bordered-right">October 18th, 2017</td>
						<td class="text-center bordered-right">November 18th, 2017</td>
						<td class="text-center">Aldi Unanto</td>
					</tr>
				</tbody>
			</table>
		</section>
		<p id="salutation" class="text-center">In response to your inquiry, we are pleased to submit our quotation as follows:</p>
		<section class="quot-content">
			<table>
				<thead>
					<tr>
